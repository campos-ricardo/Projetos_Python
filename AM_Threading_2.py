...
#from DSP_Matriz import ClassBeamforming
...
class Worker(QRunnable):
    ...
    def __init__(self, fn, *args, **kwargs):
        ...
        self.kwargs['progress_callback2'] = self.signals.progress2
        self.kwargs['progress_callback3'] = self.signals.progress3
...
class Worker1(QRunnable):
    ...
    def __init__(self, fn, *args, **kwargs):
        ...
        # Add the callback to our kwargs
        self.kwargs['progress_callback'] = self.signals.progress
        #self.kwargs['error'] = self.signals.error2
        #self.kwargs['interrupt'] = self.signals.interrupt
        #self.kwargs['progress_callback2'] = self.signals.progress2
        #self.kwargs['progress_callback3'] = self.signals.progress3
...
class Worker3(QRunnable):
    ...
    def __init__(self, fn, *args, **kwargs):
        ...
        # Add the callback to our kwargs
        self.kwargs['finished'] = self.signals.progress2
